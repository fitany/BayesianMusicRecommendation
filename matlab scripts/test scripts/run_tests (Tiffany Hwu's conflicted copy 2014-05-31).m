...
for i=5:6
    ...
    for j=1:6
        ...
        save('results_pop_thresholds2.mat','results_pop_thresholds');
...
for i=5:6
    ...
    for j=1:6
        ...
        results_query_size{i,j} = test_harness(-1,query_sizes(j),str2func(models{i}));
        save('results_query_size2.mat',results_query_size);
